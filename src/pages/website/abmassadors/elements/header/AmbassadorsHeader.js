                    ...
                    {/* <div className="brand-header-right-section">
                        ...
                        <form id="addformBrand" className="interst-form">
                            ...
                            <div className="col-12">
                                ...
                                <label htmlFor="inputcity">Email address</label>
                            ...
                            <div className="col-12">
                                ...
                                <input type="text" id="mobile_code" className="form-control" placeholder="Phone Number" name="mobile" />
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="col-12">
                                ...
                                <input type="password" className="form-control use_registration_password" id="password" name="password" placeholder="Create Password" />
                                <i toggle="#password-field" className="fa-solid fa-eye-slash eyes-toggle-password" />
                                </div>
                            </div>
                            </div>
                            <div className="row">
                            <div className="col-12">
                                ...
                                <input type="password" className="form-control use_registration_Rpassword" id="repeat_password" name="repeat_password" placeholder="Repeat password" />
                                <i toggle="#password-field" className="fa-solid fa-eye-slash eyes-toggle-Rpassword" />
                                </div>
                            </div>
                            </div>
                            <div className="row">
