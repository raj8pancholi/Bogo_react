                        ...
                        <div className="row mt-3">
                            <div className="days-input-row">
                                ...
                                <div className="checkbox-container">
                                  ...
                                  <DaysInput day='Wed' 
                                  selected={wednesdayState.status} onChange={()=> updateWednesday(!(wednesdayState.status), wednesdayState.openTime, wednesdayState.closeTime)} />

                                  <DaysInput day='Thu' 
                                  selected={thursdayState.status} onChange={()=> updateThursday(!(thursdayState.status), thursdayState.openTime, thursdayState.closeTime)} />

                                  <DaysInput day='Fri' 
                                  selected={fridayState.status} onChange={()=> updateFriday(!(fridayState.status), wednesdayState.openTime, wednesdayState.closeTime)} />

                                  <DaysInput day='Sat' 
                                  selected={saturdayState.status} onChange={()=> updateSaturday(!(saturdayState.status), saturdayState.openTime, saturdayState.closeTime)} />
                                </div>
                            </div>
                        </div>
